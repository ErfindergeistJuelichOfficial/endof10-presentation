...
* USB Stick erstellen
  - [Balena Etcher](https://etcher.balena.io/) (Mac, Windows, Linux) oder
  - [Rufus](https://rufus.ie/de/) (Windows)
:::

## Vorbereitung der Installation
::: {.incremental}
* Tastenkombination zum BIOS herausfinden: Suchmaschine „BIOS [Rechner-Modell] key combination“ (Üblich F2, F12, Delete, Esc, Enter)
